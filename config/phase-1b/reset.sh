...
echo "=== Phase 1b Reset: Resetting Attacker VM ==="
...
echo "=== Phase 1b Reset: Starting inverter ==="
...
echo "=== Phase 1b Reset: Waiting for inverter to reconnect (max 10 minutes, check every 15s) ==="
